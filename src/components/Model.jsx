...
const Model = () => {
    ...
    useGSAP(() => {
        gsap.to('#heading', { y: 0, opacity: 1, delay: 2})
    }, [])
            ...
            <div className='mx-auto w-full'>
                ...
                <div className='flex-center'>
                    <ul className='color-container'>
                        {models.map((model, i) => (
                            <li key={i} className='w-6 h-6 rounded-full mx-2 cursor-pointer' style={{backgroundColor: model.color[0]}} onClick={() => setModel(model)}/>
